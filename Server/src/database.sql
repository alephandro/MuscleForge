...
VALUES
	...
	("Incline Bench Press", "Like the Bench Press, but with an incline. Works the upper chest."),
	("Decline Bench Press", "Like the Bench Press, but with a decline. Works the lower chest."),
