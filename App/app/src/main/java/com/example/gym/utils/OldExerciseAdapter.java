...
public class OldExerciseAdapter extends RecyclerView.Adapter<OldExerciseAdapter.EntrenamientoViewHolder>{
    private List<Exercise> exercises;

    public OldExerciseAdapter(List<Exercise> entrenamientos) {
