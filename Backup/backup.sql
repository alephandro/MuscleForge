CREATE DATABASE  IF NOT EXISTS `MuscleForge` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `MuscleForge`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: MuscleForge
-- ------------------------------------------------------
...
-- Dump completed on 2024-04-24 21:33:22